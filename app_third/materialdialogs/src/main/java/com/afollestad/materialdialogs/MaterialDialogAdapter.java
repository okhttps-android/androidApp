    ...
    public View getView(final int index, View view, ViewGroup parent) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (group.getChildCount() == 2) {
                // Remove circular selector from check boxes and radio buttons
                // on Lollipop
    ...
    private void setupGravity(ViewGroup view) {
        ...
        if (view.getChildCount() == 2) {
            if (itemGravity == GravityEnum.END && !isRTL() && view.getChildAt(0) instanceof CompoundButton) {
                ...
                second.setPadding(second.getPaddingRight(), second.getPaddingTop(), second.getPaddingLeft(),
                ...
                TextView second = (TextView) view.getChildAt(0);
                view.removeView(second);
                second.setPadding(second.getPaddingRight(), second.getPaddingTop(), second.getPaddingRight(),
                        second.getPaddingBottom());
