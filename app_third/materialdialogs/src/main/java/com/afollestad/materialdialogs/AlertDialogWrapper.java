...
/**
 * Convenience class for migrating old dialogs code. Not all methods are
 * implemented yet. Using MaterialDialog.Builder directly is recommended.
 */
public class AlertDialogWrapper {
    ...
    public static class Builder {
         ...
         * @deprecated Use
         * {@link #setAdapter(ListAdapter, DialogInterface.OnClickListener)}
         * instead.
         */
        @Deprecated
         ...
         * @param checkedItems specifies which items are checked. It should be null in
         ...
         * @return This
         */
        public Builder setMultiChoiceItems(@ArrayRes int itemsId, @Nullable final boolean[] checkedItems,
         ...
         * @return This
         */
        public Builder setMultiChoiceItems(@NonNull String[] items, @Nullable final boolean[] checkedItems,
                                           final DialogInterface.OnMultiChoiceClickListener listener) {
            builder.items(items);
            setUpMultiChoiceCallback(checkedItems, listener);
            return this;
        ...
        private void setUpMultiChoiceCallback(@Nullable final boolean[] checkedItems,
                                              final DialogInterface.OnMultiChoiceClickListener listener) {
            Integer selectedIndicesArr[] = null;
            /*
             * Convert old style array of booleans-per-index to new list of
			 * indices
			 */
         ...
         * @return This
         */
        public Builder setSingleChoiceItems(@NonNull String[] items, int checkedItem,
