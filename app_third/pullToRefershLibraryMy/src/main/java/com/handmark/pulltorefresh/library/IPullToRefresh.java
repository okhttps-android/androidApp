...
public interface IPullToRefresh<T extends View> {
	...
	/**
	 * Sets the Widget to be in the pull down refresh state. The UI will be updated to
	 * show the 'Refreshing' view, and be scrolled to show such.
	 */
	public void setPullDownRefreshing();

	/**
	 * Sets the Widget to be in the pull up refresh state. The UI will be updated to
	 * show the 'Refreshing' view, and be scrolled to show such.
	 */
