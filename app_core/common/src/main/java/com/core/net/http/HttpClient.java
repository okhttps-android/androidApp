...
public class HttpClient {
    ...
    public String sendGetRequest(String url, Map<String, String> params)
        ...
        if ("city_service".equals(params.get("from"))) {
            httpGet.addHeader("Cookie", params.get("sessionId"));
        } else {
            httpGet.addHeader("Cookie", "JSESSIONID=" + params.get("sessionId"));
        }
//        httpGet.addHeader(Constants.ANDROID_USER_AGENT_KEY, Constants.ANDROID_USER_AGENT_VALUE);
    ...
    public String sendPostRequest(String url, Map<String, String> params)
        ...
        try {
            ...
            if ("city_service".equals(params.get("from"))) {
                httpPost.addHeader("Cookie", params.get("sessionId"));
            } else {
                httpPost.addHeader("Cookie", "JSESSIONID=" + params.get("sessionId"));
            }
//            httpPost.addHeader(Constants.ANDROID_USER_AGENT_KEY, Constants.ANDROID_USER_AGENT_VALUE);
