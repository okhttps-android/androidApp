...
package com.core.widget.crouton;
/*
 * Copyright 2012 - 2014 Benjamin Weiss
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
public class Style {
    ...
    public static final int holoRedLight = 0xA6ff4444;
    public static final int holoGreenLight = 0xA6454A4B;//#80000000  0xff99cc00
    public static final int holoBlueLight = 0xA6454A4B;
