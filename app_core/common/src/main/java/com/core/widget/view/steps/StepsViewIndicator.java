...
public class StepsViewIndicator extends View {
    ...
    private static  int THUMB_SIZE =98;
    ...
    private void init() {
        THUMB_SIZE= CommonUtil.dip2px(this.getContext(),33);
    ...
    private void refreshSizePosition() {
        if (mThumbContainerXPosition!=null)mThumbContainerXPosition.clear();
    ...
    protected synchronized void onDraw(Canvas canvas) {
       ...
       mDrawListener.onReady();
        ...
        textPaint.setTextSize(CommonUtil.dip2px(this.getContext(),14));
...
//            paint.setTextAlign(Paint.Align.CENTER);
            canvas.drawText("" +j, mThumbContainerXPosition.get(i), baseLineY, textPaint);
