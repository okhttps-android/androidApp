 ...
 */
public class BusinessRankListActivity extends MvpBaseActivity<BusinessManageHomeContract.IBusinessManageHomePresenter>
    ...
    protected int getLayout() {
        return R.layout.activity_business_rank_list;
    }
    ...
    protected void initView() {
        ...
        mRefreshLayout = $(R.id.business_rank_list_refresh);
        mRecyclerView = $(R.id.business_rank_list_rv);
        ...
        mRecyclerView.setAdapter(mBusinessHomeRankAdapter);
    }
    ...
    protected void initEvent() {
        mRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshLayout) {
                mPageIndex = 1;
                mPresenter.getBusinessRank(mContext,mPageIndex,mPageSize);
            }
        });
    ...
    public void requestRankSuccess(List<BusinessRankBean> businessRankBeans) {
        ...
        if (mBusinessRankBeans.size() == 0){
            ...
            mEmptyText.setText("商机转化率排行为空");
            mBusinessHomeRankAdapter.setEmptyView(mEmptyView);
        }
    }
