...
public class ItemGridDeviceQueryExactAdapter extends BaseAdapter {
    private List<SchemeConditionBean.Property> objects = new ArrayList<SchemeConditionBean.Property>();

    private Context context;
    private LayoutInflater layoutInflater;

    public ItemGridDeviceQueryExactAdapter(Context context, List<SchemeConditionBean.Property> objects) {
